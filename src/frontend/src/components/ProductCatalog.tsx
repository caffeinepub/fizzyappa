...
const FALLBACK_PRODUCTS = [
  ...
  },
  {
    ...
    priceInPaisa: BigInt(89900),
    description:
      "The ultimate Watermelon Wave experience — 12 bombs for the ultimate fizzy summer party!",
    stock: BigInt(15),
  },
  {
    id: BigInt(7),
  ...
  {
    id: BigInt(8),
    name: "Mixed Flavor Mega Box",
    flavor: "Berry Blast",
    productType: "Mega Box",
    priceInPaisa: BigInt(99900),
    description:
      "Our most popular box — 12 assorted bombs with all 6 flavors. The perfect starter collection.",
    stock: BigInt(10),
  },
  {
    id: BigInt(9),
